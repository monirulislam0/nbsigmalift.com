    ...
    <hr>
        <div class="row justify-content-center">
          ...
          <?php if(session_get("message")) : ?>
            ...
            <form action="/admin/news/update" method="post" enctype="multipart/form-data" style="padding-bottom: 100px;">
            ...
            <input type="hidden" name="id" value="<?= $news['id']?>">
              ...
              <div class="mb-3">
                ...
                <input type="text" id="news_name" class="form-control" placeholder="Enter product name" name="news_name" value="<?php 
                if(old('news_name')){
                 echo old('news_name');
                }else{
              ...
              <div class="mb-3">
                ...
                <input type="file" id="news_image" class="form-control" accept="image/*" name="news_image"  onchange="previewImages(event)">
              </div>
              <!-- Product Image -->
              <div class="mb-3">
                <img id="NewsImagePreview" src="<?php 
                  if($news['news_image']) {
                   echo  assets('/uploads/'.$news['news_image']);
                  }else{
                  echo  assets("/uploads/no_image.jpg");
                  }
              ...
              <div class="mb-3">
                ...
                <input type="text" id="alt_text" class="form-control" name="alt_text" value="<?php
                 if(old('alt_text')){
                  echo old('alt_text');
                 }else{
                   echo $news['alt_text'];
              ...
              <div class="mb-3">
               ...
               <input type="text" name="OgTitle" class="form-control" id="OgTitle" value="<?= old("OgTitle") ?? $news['og_title']?>">
              </div>
              ...
              <div class="mb-3">
                ...
                <textarea id="OgDescription" class="form-control" rows="4" placeholder="Enter product description" name="OgDescription">
                    <?= old('OgDescription') ?? $news['og_description'] ?>
                </textarea>
              </div>
              <div class="mb-3">
                <label for="OgImage" class="form-label">OG Image</label>
               <input type="file" name="OgImage" class="form-control" id="OgImage" onchange="previewImage(event)">
              </div>

              <div class="mb-3">
                <img id="imagePreview" src="<?php 
                    if($news['og_image']) {
                        echo assets('/uploads/'.$news['og_image']);
                    } else {
                        echo assets("/uploads/no_image.jpg");
                    }
                ?>" alt="OG Image" style="width: 300px; height:auto">
            </div>
            ...
            <script>
              ...
              <div class="mb-3">
                ...
                <input type="text" id="meta_tags" value="<?= old("meta_tags") ?? $news['meta_tags']?>" data-role="tagsinput"  class="form-control" name="meta_tags"/>
              </div>
              

              <div class="mb-3">
                <label for="meta_title" class="form-label">Meta Title</label>
               <input type="text" name="meta_title" class="form-control" id="meta_title" value="<?= old("meta_title") ?? $news['meta_title'] ?>">
              </div>

              <div class="mb-3">
                <label for="meta_description" class="form-label">Meta Description</label>
                <textarea id="meta_description" class="form-control" rows="4" placeholder="Enter product description" name="meta_description"><?= old('meta_description') ?? trim($news['meta_description']) ?>
                </textarea>
              </div>
              <!-- Submit Button -->
              <button type="submit" class="btn btn-success w-100">Update News</button>
            </form>
          </div>
        </div>
      </div>
