...
<main>
  <div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4 d-flex justify-content-between align-items-center">
      ...
      <li><a href="/contact-us" target="blank" class="btn btn-primary">View</a></li>
    </ol>
    <hr>
        <div class="row justify-content-center">
          ...
          <?php if(session_get("message")) : ?>
            ...
            <form action="/admin/pages/contact-us/store" method="post" enctype="multipart/form-data" style="padding-bottom: 100px;">
              <!-- Product Name -->
 ...
 <!-- Product Alt Text -->
            <div class="mb-3">
                <label for="google_iframe" class="form-label">Our Locationt</label>
                <input type="text" id="google_iframe" class="form-control" name="google_iframe" placeholder="Paste google emebeded...">
              </div>
              <!-- Location -->
              <div class="mb-3">
                <div class="google_iframe p-2">
                <style>
                iframe{
                    width:100% !important;
