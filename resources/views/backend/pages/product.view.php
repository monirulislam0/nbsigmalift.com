...
<main>
  <div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4 d-flex justify-content-between align-items-center">
      ...
      <li><a href="/products" target="blank" class="btn btn-primary">View</a></li>
    </ol>
    <hr>
        <div class="row justify-content-center">
          ...
          <?php if(session_get("message")) : ?>
            ...
            <form action="/admin/pages/product/store" method="post" enctype="multipart/form-data" style="padding-bottom: 100px;">
              <!-- Product Name -->
