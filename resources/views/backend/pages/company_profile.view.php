...
<main>
  <div class="container-fluid px-4">
    ...
    <ol class="breadcrumb mb-4 d-flex justify-content-between align-items-center">
      <li class="breadcrumb-item active">Compnay Profile</li>
      <li><a href="/company-profile" target="blank" class="btn btn-primary">View</a></li>
    </ol>
    <hr>
        <div class="row justify-content-center">
          ...
          <?php if(session_get("message")) : ?>
            ...
            <h1 class="mb-4">Factory Tours</h1>
            <form action="/admin/pages/company-profile/store" method="post" enctype="multipart/form-data" style="padding-bottom: 100px;">
              <!-- Product Name -->
