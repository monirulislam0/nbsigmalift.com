                            ...
                            <div class="col-xl-12">
                                    ...
                                    <form action="/admin/slider/store" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="mb-3 d-flex justify-content-center align-items-center">
                                                <img src="<?= assets("/frontend/media/slider-1.jpg") ?>" alt="slider" style="width: 800px" id="show_slider">
                                            </div>
                                            <script>
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" name="alternative_text" class="form-control" id="alt_text"  value="This is Hayashimu Lift Slider" >
                                                </div>
                                            <div class="mb-3">
                                                <div class="action-group d-flex justify-content-end">
                                                            <input type="submit" class="btn btn-primary" value="Add" style="width: 250px">                                           
                                                </div>
                                            </div>
                                    </form>
