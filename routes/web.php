...
// Profile Password Changed Route

Router::get('/admin/reset/password', [SessionController::class, 'ResetPassword'])->middleware('auth');
Router::post('/admin/reset/password/store', [SessionController::class, 'StorePassword'])->middleware('auth');
